...
folder are mapped to the application's root namespace, 'corporacionsoluma'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "corporacionsoluma"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'corporacionsoluma' in the same way
as `"corporacionsoluma/sass/src"`.
