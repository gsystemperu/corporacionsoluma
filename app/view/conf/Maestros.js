Ext.define('corporacionsoluma.view.conf.Maestros', {
    ...
    requires: [
        ...
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
        'corporacionsoluma.view.conf.AccionesRegConfig',
        ...
        var obj = {
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.estadoGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            reference: 'idestado',
                    ...
                    tbar: [
                        ...
                        },
                        {
                            xtype: 'button',
                            text: 'Guardar',
                             glyph: corporacionsoluma.util.Glyphs.getGlyph('guardar'),
        ...
        var obj = {
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.bancoGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            reference: 'idbanco',
    ...
    getPanelCategorias:function(storeCategoria){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.categoriaGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
    ...
    getPanelColores:function(storeColores){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.colorGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            reference: 'idColor',
     ...
     getPanelMedidas:function(storeMedidas){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.medidaGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            reference: 'idMedidas',
     ...
     getPanelUnidadMedida:function(storeUnidadMedidas){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.unidadMedidaGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            value: 0
    ...
    getPanelTipoDeProducto:function(storeTipoProductos){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.tipoProductoGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
    ...
    getPanelTarifas:function(storeTarifas){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                    url: corporacionsoluma.util.Rutas.TarifaGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            reference: 'idTarifa',
    ...
    getPanelPresentacionProducto:function(storePresentacion){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                  url: corporacionsoluma.util.Rutas.presentacionGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'idpres',
                            reference: 'idTipoProducto',
    ...
    getPanelFormaPago:function(storeFormaPago){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                      url: corporacionsoluma.util.Rutas.formaPagoGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'idfopag',
    ...
    getPanelModoDeEntrega:function(storeModoEntrega){
            ...
            items: [{
                ...
                },
                {
                    ...
                    bodyPadding: 10,
                    layout: 'anchor',
                      url: corporacionsoluma.util.Rutas.modoEntregaGuardar,
                    items: [{
                            xtype: 'hiddenfield',
                            name: 'id',
                            reference: 'idTipoProducto',
    ...
    getPanelMarca:function(storeMarca)
    {
       ...
       items: [{
           ...
           },
           {
               ...
               bodyPadding: 10,
               layout: 'anchor',
               url: corporacionsoluma.util.Rutas.marcaGuardar,
               items: [{
                       xtype: 'hiddenfield',
                       name: 'id',
                       reference: 'idMarca',
    ...
    getPanelModelo:function(storeModelo)
    {
       ...
       items: [{
           ...
           },
           {
               ...
               bodyPadding: 10,
               layout: 'anchor',
              url: corporacionsoluma.util.Rutas.modeloGuardar,
               items: [{
                       xtype: 'hiddenfield',
                       name: 'id',
                       reference: 'idModelo',
    ...
    getItems: function () {
        var storeEstado = Ext.create('corporacionsoluma.store.Estados');
        //var storeBancos = Ext.create('corporacionsoluma.store.Bancos');
        var storeCategoria = Ext.create('corporacionsoluma.store.Categoria');
        //var storeColores = Ext.create('corporacionsoluma.store.Colores');
        //var storeMedidas = Ext.create('corporacionsoluma.store.Medidas');
        var storeTipoProductos = Ext.create('corporacionsoluma.store.TipoDeProductos');
        var storeUnidadMedidas = Ext.create('corporacionsoluma.store.UnidadDeMedidas');
        //var storeTarifas = Ext.create('corporacionsoluma.store.Tarifas');

        var storePresentacion = Ext.create('corporacionsoluma.store.Presentacion');
        var storeFormaPago  = Ext.create('corporacionsoluma.store.FormaPago');
        var storeModoEntrega = Ext.create('corporacionsoluma.store.ModoEntrega');

        var storeModelos = Ext.create('corporacionsoluma.store.Modelos');
        var storeMarcas  = Ext.create('corporacionsoluma.store.Marcas');
