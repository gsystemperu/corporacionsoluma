...
Ext.define('corporacionsoluma.view.almacen.ProductoUbicacion', {
    extend: 'Ext.window.Window',
    xtype:'wProductoUbicacion',
    requires:['corporacionsoluma.view.almacen.AccionesUbicacion'],
    modal:true,
    ...
    getItems:function(codigoserie){
      storeA = Ext.create('corporacionsoluma.store.Almacenes');
      storeS = Ext.create('corporacionsoluma.store.AlmacenSecciones');
      return obj = [
        {
            xtype: 'container',
            scrollable: true,
