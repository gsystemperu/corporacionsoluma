Ext.define('corporacionsoluma.view.almacen.FormProducto', {
    ...
    requires   : [
        ...
        'corporacionsoluma.view.almacen.AccionesProducto',
    ...
    url: corporacionsoluma.util.Rutas.productoGuardar,
    layout: {
      type: 'vbox',
      pack: 'start',
      align: 'stretch'
    ...
    initComponent: function() {
        ...
        var storeMedida = Ext.create('corporacionsoluma.store.Medidas');
        var storeUnidadMedida = Ext.create('corporacionsoluma.store.UnidadDeMedidas');
        var storeTipoProd = Ext.create('corporacionsoluma.store.TipoDeProductos');
        var storeProveedores = Ext.create('corporacionsoluma.store.Proveedores');
    ...
    getFormularioProducto: function (storeColores, storeMedida, storeUnidadMedida, storeTipoProd,storeProveedores,storePresentacion,storeModelos,storeMarcas ) {
      _storeDetProvProd = Ext.create('corporacionsoluma.store.DetProductoProveedor', {});
      ...
      var obj = [
        ...
        },
        {
          ...
          items :[
            ...
            {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('nuevo'),handler:'onClickNuevoTipoProducto'},
            {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('refrescar'),
       ...
       
        {
          ...
          items: [
             ...
             {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('nuevo'),handler:'onClickNuevoUnidadMedida'},
             {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('refrescar'),handler:'onClickRefrescarModelo'},
           
             {
              ...
              {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('nuevo'),handler:'onClickNuevoUnidadMedida'},
              {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('refrescar'),handler:'onClickRefrescarMarca'},
        ...
        },
        {
          ...
          items: [
            ...
            {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('nuevo'),handler:'onClickNuevoUnidadMedida'},
            {xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('refrescar'),handler:'onClickRefrescarUnidadMedida'},
            {
              ...
              {
                xtype:'button',glyph: corporacionsoluma.util.Glyphs.getGlyph('nuevo'),
