Ext.define('corporacionsoluma.view.almacen.ContenedorProducto', {
  ...
  requires: [
    ...
    'corporacionsoluma.view.almacen.Producto',
    'corporacionsoluma.view.almacen.ProductoExistencias',
    'corporacionsoluma.view.almacen.FormProducto'
  ],
  layout: {
    type: 'card',
    align: 'stretch',
