Ext.define('corporacionsoluma.view.almacen.InventarioInicialEditar', {
    ...
    requires: [
        ...
        'corporacionsoluma.view.almacen.InventarioInicialEditarController',
        'corporacionsoluma.view.almacen.InventarioInicialEditarModel',
        //'corporacionsoluma.view.almacen.InventarioInicialController',
        'Ext.grid.*',
        'Ext.form.field.*',
        'Ext.grid.plugin.*'
    ],
    ...
    url: corporacionsoluma.util.Rutas.inventarioAgregar,
    ...
    initComponent: function () {
        var st = Ext.create('corporacionsoluma.store.ProductoInventarioLista');
