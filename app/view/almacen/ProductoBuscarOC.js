Ext.define('corporacionsoluma.view.almacen.ProductoBuscarOC', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('corporacionsoluma.store.ProductosOrdenCompra');
        storeProducto.load({
          params:{
            idprov : me.getProveedor()
          }
        });
        storeTipoProd  = null; //Ext.create('corporacionsoluma.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
