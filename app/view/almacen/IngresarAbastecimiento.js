Ext.define('corporacionsoluma.view.almacen.IngresarAbastecimiento', {
    extend: 'Ext.window.Window',
    xtype: 'wingresarabastecimiento',
    requires: [
        'Ext.grid.plugin.*',
        'corporacionsoluma.view.almacen.AccionesReglasAbastecimiento',
    ...
    initComponent: function () {
        ...
        var storeTipoDoc      = Ext.create('corporacionsoluma.store.TipoDocumento');
        var storeProveedores = Ext.create('corporacionsoluma.store.Proveedores');
        var storeDetalle      = Ext.create('corporacionsoluma.store.DetalleAbastecimiento');
        me = this;
        Ext.applyIf(me, {
            items: [{
                    xtype: "form",
                    ...
                    url: corporacionsoluma.util.Rutas.abastecimientoGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
