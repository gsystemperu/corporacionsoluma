Ext.define('corporacionsoluma.view.almacen.ProductoBuscar', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('corporacionsoluma.store.Productos');
        storeTipoProd  = Ext.create('corporacionsoluma.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
