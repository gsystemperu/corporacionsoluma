...
Ext.define('corporacionsoluma.view.almacen.AccionesReglasAbastecimiento', {
    ...
    onClickIngresar:function(){
        Ext.create('corporacionsoluma.view.almacen.IngresarAbastecimiento');
    },
    onClickBuscarProducto:function(btn){
        Ext.create('corporacionsoluma.view.almacen.ProductoBuscar');
    },
    ...
    onClickFormularioProveedor :function(btn){
        var win   = Ext.create('corporacionsoluma.view.almacen.FormProveedor',{control: btn.control.toString()});
    },
