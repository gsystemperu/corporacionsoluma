...
Ext.define('corporacionsoluma.view.almacen.AccionesUbicacion', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.acciones-ubicacion',
    requires:['corporacionsoluma.util.Rutas','corporacionsoluma.util.Util'],
    ...
    onClickGuardarUbicacion:function(){
        ...
        Ext.Ajax.request({
            url :corporacionsoluma.util.Rutas.productoGuardarUbicacion,
            params:{
            ...
            success:function(response){
               var rs = corporacionsoluma.util.Util.decodeJSON(response.responseText);
               if(rs.error>0){
                 me.getView().unmask();
