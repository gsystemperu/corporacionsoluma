Ext.define('corporacionsoluma.view.almacen.Almacenes', {
  extend: 'Ext.panel.Panel',
  xtype: 'wRegAlmacen',
  alias: 'widget.wRegAlmacen',
  requires: [
    'Ext.layout.container.HBox',
    'corporacionsoluma.view.almacen.AccionesAlmacen',
    'Ext.grid.*',
  ...
  initComponent: function () {
    me = this;
      store = Ext.create('corporacionsoluma.store.Almacenes');
    Ext.apply(this, {
      items: [
  ...
  getPanelAlmacen: function (store) {
    ...
    var obj = {
      ...
      items: [{
       ...
       url: corporacionsoluma.util.Rutas.almacenGuardar,
        flex: 1,
        layout: {
          type: 'vbox',
          pack: 'start',
  ...
  getPanelAlmacenSession: function (storealmacen) {
    store = Ext.create('corporacionsoluma.store.AlmacenSecciones');
    var obj = {
      xtype: 'panel',
      flex: 1.5,
      items: [{
        ...
        url : corporacionsoluma.util.Rutas.seccionAlmacenGuardar,
        flex: 1,
        layout: {
          type: 'vbox',
          pack: 'start',
