Ext.define('corporacionsoluma.view.almacen.ActualizarDisponibilidad',{
    extend: 'Ext.window.Window',
    alias : 'widget.wActDisponibilidad',
    xtype : 'wActDisponibilidad',
    itemId : 'wActDisponibilidad',
    requires: [
        'corporacionsoluma.view.almacen.ActualizarDisponibilidadController',
    ],
    autoShow:true,
    width : 700,
    height:158,
    ...
    items:[
        {
            ...
            reference : 'frmdispo',
            itemId : 'frmdispo',
            url : corporacionsoluma.util.Rutas.productoActualizarCantidad,
            layout:{
                type:'vbox',
                pack: 'start',
                align: 'stretch'
