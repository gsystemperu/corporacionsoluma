Ext.define('corporacionsoluma.view.almacen.AccionesProveedor', {
    ...
    onClickGuardarProveedorModal: function (btn) {
        ...
        if (_form.isValid()) {
            _form.submit({
                ...
                failure: function () {
                    Ext.Msg.alert("Aviso", "Error en conexion de la base de datos");
                }
            });
    ...
    onKeyPressTextoDeBusquedaProveedor: function (txt, e, eOpts) {
     ...
     onClickEliminarProveedor:function(btn){
        me = this;
        Ext.Ajax.request({
                url: corporacionsoluma.util.Rutas.proveedorEliminar, 
