Ext.define('corporacionsoluma.view.ventas.Imprimir', {
    ...
    getItems:function(){
      var storeOrientacion = Ext.create('corporacionsoluma.store.PosicionReporte');
      var storeFormato     = Ext.create('corporacionsoluma.store.FormatoReporte');
      var storeFirmas     = Ext.create('corporacionsoluma.store.Firmas');
