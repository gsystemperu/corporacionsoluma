Ext.define('corporacionsoluma.view.ventas.BuscarProductoFB', {
    extend: 'Ext.window.Window',
    alias: 'widget.wBuscarProductoFB',
    xtype: 'wBuscarProductoFB',
    requires: [
      'corporacionsoluma.view.ventas.AccionesRegFacturaBoleta'
    ],
    config : {
      cliente : 0,
      detalle : null
    ...
    initComponent: function () {
        var store = Ext.create('corporacionsoluma.store.ProductosPorPrecioPersona');
        me        = this;
