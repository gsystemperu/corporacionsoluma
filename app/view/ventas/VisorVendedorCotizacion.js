Ext.define('corporacionsoluma.view.ventas.VisorVendedorCotizacion', {
    ...
    getItems: function () {
        var storeVendedor = Ext.create('corporacionsoluma.store.Vendedores');
        var storeEstadistica = Ext.create('corporacionsoluma.store.CotizacionesEstadisticaVendedor');
        var obj = [{
                xtype: 'container',
                flex: 0.8,
                layout: {
