Ext.define('corporacionsoluma.view.ventas.EditarCotizacion', {
    ...
    initComponent: function () {
        ...
        //var storeDetCot = Ext.create('corporacionsoluma.store.CotizacionesDetalle');
        ...
        Ext.applyIf(me, {
            items: [{
                    ...
                    url: corporacionsoluma.util.Rutas.cotizacionGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
                            ...
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    buttons: [{
                                            ...
                                            text: 'Cancelar',
                                            scale: 'medium',
                                            glyph: corporacionsoluma.util.Glyphs.getGlyph('cancelar'),
