Ext.define('corporacionsoluma.view.ventas.RegistrarFacturaBoleta', {
    ...
    initComponent: function () {
        ...
        var storeClientes = Ext.create('corporacionsoluma.store.Clientes');
        var storeProductos = Ext.create('corporacionsoluma.store.Productos');
        var storeDetCotizacion = Ext.create('corporacionsoluma.store.DetalleCotizacion');
        ...
        var storeVendedores = Ext.create('corporacionsoluma.store.Vendedores');
        var storeMonedas = Ext.create('corporacionsoluma.store.Monedas');
        var storeDocumentoVenta = Ext.create('corporacionsoluma.store.DocumentoVenta');
        ...
        Ext.applyIf(me, {
            items: [{
                    ...
                    padding : 10,
                    url: corporacionsoluma.util.Rutas.facturacionGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
                                    ...
                                    items: [{
                                            ...
                                            items: [{
                                                ...
                                                /*{
                                                    xtype: 'button',
                                                    text :'Cotizaciones',
                                                    glyph: corporacionsoluma.util.Glyphs.getGlyph('buscar'),
