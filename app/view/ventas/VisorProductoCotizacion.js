Ext.define('corporacionsoluma.view.ventas.VisorProductoCotizacion', {
    ...
    getItems: function () {
        ...
        var storeEstadistica = Ext.create('corporacionsoluma.store.CotizacionesEstadisticaProducto');
        var obj = [{
                xtype: 'container',
                flex: 0.8,
                layout: {
