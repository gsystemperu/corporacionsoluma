Ext.define('corporacionsoluma.view.ventas.GuiaRemision', {
    ...
    requires: [
        ...
        'corporacionsoluma.view.ventas.AccionesGuiaRemision'
    ],
    itemId: 'wGuiaRemision',
    controller: 'acciones-guiaremision',
    initComponent: function () {
        me = this;
        __storeGuiaRemisionDetalle = Ext.create('corporacionsoluma.store.GuiaRemisionDetalle');
        __storeMotivosTranslado = Ext.create('corporacionsoluma.store.MotivosTranslados');
        Ext.applyIf(me, {
            items: [
                {
                    xtype: "form",
                    ...
                    url: corporacionsoluma.util.Rutas.guiaRemisionActualizar,
                    items: [
                        {
                            xtype: 'panel',
                            border: false,
