Ext.define('corporacionsoluma.view.ventas.AccionesGuiaRemision', {
    ...
    onClickGuardarGuiaRemision:function(btn){
        ...
        if (_form.isValid())
        {
            ...
            _form.submit({
                ...
                failure: function () {
                     Ext.Msg.alert("Aviso", "Error al ingresar guia remision");
                     return false;

                }
            });
        } else {
            corporacionsoluma.util.Util.showErrorMsg('Ingresar los datos de la guia de remisión!!');
        }
