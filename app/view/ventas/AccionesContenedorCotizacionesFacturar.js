Ext.define('corporacionsoluma.view.ventas.AccionesContenedorCotizacionesFacturar', {
          ...
          Ext.Ajax.request({
              ...
              success:function(response){
                ...
                __objSubTotal.setValue(
                     Ext.util.Format.number(s.toFixed(5), "0,000.00000")
                 );
                 __objIgv.setValue(
                     Ext.util.Format.number(i.toFixed(5), "0,000.00000")
                 );
                 __objTotal.setValue(
    ...
    onClickDocumentoImprimir:function(btn){
      try {
          ...
          //if(_record.get('idguia')>0){
            ...
            //var objrpt = window.open( corporacionsoluma.util.Rutas.rptImprimirNota+
            //'id='+ _record.get('idfacturacion'), "", "width=700,height=900");
            //setTimeout(function(){ objrpt.close()}, 4000);

            var objrpt = window.open( corporacionsoluma.util.Rutas.rptImprimirNota+ 'id='+ _record.get('idfacturacion'), "", "width=700,height=900");
    ...
    onClickGuiasRemisionImpresion:function(btn){
      try {
          var _record =  Ext.ComponentQuery.query('#dgvVentasFacturar')[0].getSelectionModel().getSelection()[0];
          if(_record.get('idguia')>0){
            var objrpt = window.open( corporacionsoluma.util.Rutas.rptImprimirGuiaRemision+
    ...
    onClickEnviarSunatFacturas:function(){
      Ext.Msg.alert("Aviso","Módulo en contrucción");
    }
