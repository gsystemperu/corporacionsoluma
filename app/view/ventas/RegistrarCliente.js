Ext.define('corporacionsoluma.view.ventas.RegistrarCliente', {
    ...
    initComponent: function() {
        var storeTipoDoc = Ext.create('corporacionsoluma.store.TipoDocumentos');
        me = this;
        Ext.apply(me, {
            items: [
                {
                    ...
                    url : corporacionsoluma.util.Rutas.clienteGuardar,
                    bodyPadding: 5,
                    layout: {
                        type: 'hbox',
                        align: 'stretch'
