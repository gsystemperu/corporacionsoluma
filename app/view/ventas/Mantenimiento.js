Ext.define('corporacionsoluma.view.ventas.Mantenimiento', {
    ...
    requires: [
        ...
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
        'corporacionsoluma.view.ventas.AccionesMantenimiento'
    ],
    autoShow: true,
    width: 900,
    height: 400,
    ...
    getItems: function () {
        var storeUM = Ext.create('corporacionsoluma.store.UnidadMedida');
        var storeME = Ext.create('corporacionsoluma.store.ModoEntrega');
        var storeFP = Ext.create('corporacionsoluma.store.FormaPago');
        var storeVE = Ext.create('corporacionsoluma.store.Vendedores');
        var storePR = Ext.create('corporacionsoluma.store.Presentacion');
        var storeCA = Ext.create('corporacionsoluma.store.Categoria');
        ...
        var _obj = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: corporacionsoluma.util.Rutas.vendedorGuardar,
