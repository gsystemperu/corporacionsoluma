Ext.define('corporacionsoluma.view.ventas.ListadoDeCotizacionesFacturar', {
    ...
    requires: [
        ...
        'Ext.form.field.*',
        'Ext.panel.Panel',
        'corporacionsoluma.view.ventas.AccionesRegCotizacionesFacturar',
    ...
    initComponent: function () {
        var storeCotiFacturar    = Ext.create('corporacionsoluma.store.CotizacionesFacturar');
