...
Ext.define('corporacionsoluma.view.ventas.ContenedorCotizaciones', {
  ...
  requires: [
    ...
    'corporacionsoluma.view.ventas.AccionesContenedorCotizaciones',
    'corporacionsoluma.view.ventas.RegistrarCotizacion'
  ],
  layout: {
    type: 'card',
    align: 'stretch',
