Ext.define('corporacionsoluma.view.compras.ContenedorGuias', {
  ...
  requires: [
    ...
    'corporacionsoluma.view.compras.AccionesContenedorGuias',
    'corporacionsoluma.view.compras.IngresoGuia',
  ...
  mostrarIngresoGuias: function () {
    ...
    if(_rec){
       ...
       _store.removeAll();
       Ext.Ajax.request({
           url : corporacionsoluma.util.Rutas.OrdenCompraConfirmadaDetalle,
           params:{
             id :  _rec.get('id')
           },
           success:function(response){
              _data = corporacionsoluma.util.Util.decodeJSON(response.responseText);
              _id   = 0;
