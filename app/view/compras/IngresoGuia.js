Ext.define('corporacionsoluma.view.compras.IngresoGuia', {
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmdaDet = Ext.create('corporacionsoluma.store.TmpOrdenCompraConfirmadas');
  ...
  getDatosDelProveedor: function () {
    return obj = {
      ...
      url: corporacionsoluma.util.Rutas.guiaProveedorGuardar,
      layout: 'hbox',
      padding: 5,
      bodyPadding: 5,
      defaults: {
