Ext.define('corporacionsoluma.view.compras.EditarOrdenCompra', {
    extend: 'Ext.panel.Panel',
    xtype: 'weditarordencompra',
    requires: [
        'Ext.grid.plugin.*',
        'corporacionsoluma.view.compras.AccionesOrdenCompraEditar',
    ...
    initComponent: function () {
        ...
        var storeDetalle = Ext.create('corporacionsoluma.store.DetalleOrdenCompra');
            ...
            items: [
                {
                    ...
                    url: corporacionsoluma.util.Rutas.ordenCompraEditar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
