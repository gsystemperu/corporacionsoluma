Ext.define('corporacionsoluma.view.compras.IngresarOrdenCompra', {
    extend: 'Ext.panel.Panel',
    xtype: 'wingresarordencompra',
    requires: [
        'Ext.grid.plugin.*',
        'corporacionsoluma.view.compras.AccionesOrdenCompra',
    ...
    initComponent: function () {
        ...
        storeProveedores = Ext.create('corporacionsoluma.store.Proveedores');
        storeDetalle     = Ext.create('corporacionsoluma.store.DetalleOrdenCompra');
        storeMonedas     = Ext.create('corporacionsoluma.store.Monedas');
        sfpag            = Ext.create('corporacionsoluma.store.FormaPago');
        sAlam            = Ext.create('corporacionsoluma.store.Almacenes');
        me = this;
        Ext.applyIf(me, {
            items: [
                {
                    ...
                    url: corporacionsoluma.util.Rutas.ordenCompraGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'button',
                                                    glyph: corporacionsoluma.util.Glyphs.getGlyph('refrescar'),
