Ext.define('corporacionsoluma.view.compras.GuiasEntrada', {
  ...
  requires: [
    ...
    'corporacionsoluma.view.compras.AccionesGuia',
    'Ext.grid.plugin.*'
  ],
  layout: {
    type: 'vbox',
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmada = Ext.create('corporacionsoluma.store.OrdenesCompraConfirmadas');
    var storeProveedores = Ext.create('corporacionsoluma.store.Proveedores');
    var storeOrdenCompraConfirmdaDet = Ext.create('corporacionsoluma.store.DetalleIngresoGuiaVista');
  ...
  getPanelToolBarAbastecimiento: function (storeProveedores) {
    return obj = {
      ...
      items: [{
          ...
          xtype: 'button',
          glyph: corporacionsoluma.util.Glyphs.getGlyph(
            'buscar'),
