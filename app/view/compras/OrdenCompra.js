Ext.define('corporacionsoluma.view.compras.OrdenCompra', {
  ...
  initComponent: function () {
    var storeAbastecimiento = Ext.create('corporacionsoluma.store.OrdenesCompras');
    var storeProveedores = Ext.create('corporacionsoluma.store.Proveedores');
    var storeAbastecimientoDet = Ext.create('corporacionsoluma.store.AbastecimientoDetalle');
