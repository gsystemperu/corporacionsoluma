Ext.define('corporacionsoluma.view.compras.PagosAcuenta', {
    ...
    requires   : [
        ...
        'Ext.grid.*',
        'corporacionsoluma.view.compras.AccionesPagosAcuenta'
    ...
    initComponent: function()
    {
        ...
        Ext.Ajax.request({
              url : corporacionsoluma.util.Rutas.ordenCompraBuscarPagoAcuenta,
              params:{
