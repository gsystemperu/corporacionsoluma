Ext.define('corporacionsoluma.view.mrp.FormListaMaterial', {
    ...
    requires   : [
        ...
        'corporacionsoluma.view.mrp.AccionesFormListaMaterial',
    ...
    initComponent: function() {
        ...
        var storeProducto     = Ext.create('corporacionsoluma.store.Productos');
        //storeProducto.load();
    ...
    getFormularioProducto: function (storeUnidadMedida, storeProveedores,storeProducto) {
      _storeDetListaMateriales = Ext.create('corporacionsoluma.store.DetListaMateriales', {});
      storeProducto.load();
      var obj = [
        {
          xtype:'hiddenfield',
