Ext.define('corporacionsoluma.view.puntoventa.ListadoPdv', {
    ...
    requires: [
        ...
        'Ext.form.field.*',
        'Ext.panel.Panel',
        'corporacionsoluma.view.puntoventa.AccionesListadoPdv',
    ...
    initComponent: function () {
        var storeCotiFacturar    = Ext.create('corporacionsoluma.store.PuntoVentaPagos');
