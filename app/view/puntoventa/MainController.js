Ext.define('corporacionsoluma.view.puntoventa.MainController', {
  ...
  onClickGuardarCajaPago: function (btn) {
    ...
    if (fm.isValid()) {
      ...
      if (st.getCount() == 0) { corporacionsoluma.util.Util.showToast("TIENE QUE INGRESAR PRODUCTOS"); return false; }
      ...
      Ext.Ajax.request({
        url: corporacionsoluma.util.Rutas.facturacionGuardarPagoPuntoVenta,
        params: {
          id: 0,
          idcoti: 0,
        ...
        success: function (response) {
          ...
          if (__data.error != 0) {
            ...
            corporacionsoluma.util.Util.showToast("GUARDADO");
            ...
            objrpt = window.open(corporacionsoluma.util.Rutas.imprimirTicket + 'id=' + __data.error, "", "width=700,height=900");

            // Impresion Matricial
            // objrpt = window.open( corporacionsoluma.util.Rutas.rptImprimirNota+ 
