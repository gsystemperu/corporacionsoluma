Ext.define('corporacionsoluma.view.ventas.AccionesPagosAcuentaPdv', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.acciones-pagosacuentapdv',
    ...
    onClickGuardarPagoAcuenta:function(btn){
      ...
      if(__store){
        ...
        Ext.Ajax.request({
            url :corporacionsoluma.util.Rutas.facturacionAgregarPagosAcuenta,
            params:{
            ...
            success:function(response){
                  ...
                  if(__data.error!=0){
                    corporacionsoluma.util.Util.showToast('Registrado');
                    __view.close();
                    Ext.ComponentQuery.query('#dgvVentasFacturarPdv')[0].getStore().reload();
                  }
            }
        });
      }
