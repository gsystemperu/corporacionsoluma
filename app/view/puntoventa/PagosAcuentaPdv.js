Ext.define('corporacionsoluma.view.puntoventa.PagosAcuentaPdv', {
    ...
    requires   : [
        'Ext.form.field.*',
        'corporacionsoluma.util.*',
        'Ext.grid.*',
        'corporacionsoluma.view.ventas.AccionesPagosAcuentaPdv'
    ],
    config : {
        nombre : '',
        monto  : 0,
   ...
   controller:'acciones-pagosacuentapdv',
    ...
    {
        me = this;
        __store = Ext.create('corporacionsoluma.store.PagosAcuenta');
        ...
        Ext.Ajax.request({
              url : corporacionsoluma.util.Rutas.facturacionBuscarPagosAcuenta,
              params:{
