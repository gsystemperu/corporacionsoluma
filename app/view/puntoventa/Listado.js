Ext.define('corporacionsoluma.view.puntoventa.Listado',{
    extend: 'Ext.panel.Panel',
    xtype :'wListadoProducto',
    alias : 'wListadoProducto',
    requires: [
        'corporacionsoluma.view.puntoventa.ListadoController',
    ...
    initComponent:function(){
        me = this;
        __storeProducto     = Ext.create('corporacionsoluma.store.Productos');
