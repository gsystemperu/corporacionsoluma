...
Ext.define('corporacionsoluma.view.puntoventa.Main',{
    extend: 'Ext.form.Panel',
    alias: 'wPdv',
    xtype: 'wPdv',
    itemId :'wPdv',
    requires: [
        'corporacionsoluma.view.puntoventa.Listado',
        'corporacionsoluma.view.puntoventa.MainController',
        'Ext.grid.plugin.*',
        'Ext.grid.Panel',
    ...
    initComponent: function () {
       me = this;
       var _storeDetalle =Ext.create('corporacionsoluma.store.CajaDetalleVenta');
       //var _storeFormaPago = Ext.create('corporacionsoluma.store.FormaPago');
       Ext.apply(me, {
