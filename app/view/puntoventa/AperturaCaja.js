Ext.define('corporacionsoluma.view.puntoventa.AperturaCaja', {
    ...
    requires   : [
        ...
        'Ext.grid.*',
        'corporacionsoluma.view.puntoventa.AccionesAperturaCaja'
    ...
    {
        me = this;
        __store = Ext.create('corporacionsoluma.store.NombreMoneda');
