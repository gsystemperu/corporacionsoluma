Ext.define('corporacionsoluma.model.DataModels', {
...
// @Model : Estado
Ext.define('corporacionsoluma.model.Estado', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Banco
Ext.define('corporacionsoluma.model.Banco', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Almacen
Ext.define('corporacionsoluma.model.Almacen', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.AlmacenSecciones', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.Categoria', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Almacen Color
Ext.define('corporacionsoluma.model.Color', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Medidas
Ext.define('corporacionsoluma.model.Medida', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.TipoDeProducto', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.UnidadDeMedida', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Tarifa
Ext.define('corporacionsoluma.model.Tarifa', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Marca
Ext.define('corporacionsoluma.model.Marca', {
    extend: 'Ext.data.Model',
    fields: [
       {
            name: 'id',
...
// @Model : Modelo
Ext.define('corporacionsoluma.model.Modelo', {
    extend: 'Ext.data.Model',
    fields: [
       {
            name: 'id',
...
// @Model : Producto
Ext.define('corporacionsoluma.model.Producto', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
// @Model : Tarifa
Ext.define('corporacionsoluma.model.Proveedor', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.Abastecimiento', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.AbastecimientoDetalle', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'idaba',
            type: 'int'
...
//eddy erazo 
Ext.define('corporacionsoluma.model.OrdenCompra', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
//
Ext.define('corporacionsoluma.model.OrdenCompraDetalle', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.ProductoExistencia', {
    extend: 'Ext.data.Model',
    fields: [
        {name :'id',type:'int'},
...
// @Model : Moneda
Ext.define('corporacionsoluma.model.Moneda', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.NombreMoneda', {
    extend: 'Ext.data.Model',
    fields: [{
            name: 'id',
            type: 'int'
...
Ext.define('corporacionsoluma.model.GuiaRemisionDetalle', {
    extend: 'Ext.data.Model',
    fields: [
        {name: 'idordencompra',type: 'int'},
        {name :'item',type:'int'},
...
//
Ext.define('corporacionsoluma.model.InventarioRegistro', {
    extend: 'Ext.data.Model',
    fields: [
        {name: 'id',type: 'string'},
...
//
Ext.define('corporacionsoluma.model.ProductoInventario', {
    extend: 'Ext.data.Model',
    fields: [
...
//
Ext.define('corporacionsoluma.model.Serie', {
    extend: 'Ext.data.Model',
    fields: [
        {name :'id',type:'integer'},
...
// @Model : Ticketeas
//
Ext.define('corporacionsoluma.model.Ticketera', {
    extend: 'Ext.data.Model',
    fields: [
        {name :'id',type:'integer'},
...
// @Model : Tiendas
//
Ext.define('corporacionsoluma.model.Tienda', {
    extend: 'Ext.data.Model',
    fields: [
        {name :'id',type:'integer'},
