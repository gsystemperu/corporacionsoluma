Ext.define('corporacionsoluma.model.DataModelVentas', {extend: 'Ext.data.Model',fields: [{ name: 'id', type: 'int' }]});

// @Model : Producto
Ext.define('corporacionsoluma.model.ProductoPorCliente', {
...
// @Model : Cliente
Ext.define('corporacionsoluma.model.Cliente', {
    extend: 'Ext.data.Model',
    fields: [
        { name: 'idper', type: 'int' },
...
Ext.define('corporacionsoluma.model.TipoDocumento', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.TipoDocumentoVenta', {
    extend: 'Ext.data.Model',
    fields: [
        { name: 'id', type: 'int' },
        { name: 'descripcion', type: 'string' },
...
Ext.define('corporacionsoluma.model.Cotizacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.CotizacionDetalle', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.FormaPago', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.ModoEntrega', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.Vendedor', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.UnidadMedida', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.Presentacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.EstProducto', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.CotizacionesFacturar', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.DetFacturacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('corporacionsoluma.model.DetalleIngresoGuiaVista', {
    extend: 'Ext.data.Model',
    fields: [
...
// @Model Detalle de ingreso al almacen , muestra todos los ingresos de una orden de compra
Ext.define('corporacionsoluma.model.MotivoTranslado', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "descripcion", type:'string' },
