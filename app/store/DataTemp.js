Ext.define('corporacionsoluma.store.DataTemp', {
...
Ext.define('corporacionsoluma.store.TipoDocumento', {
    extend: 'Ext.data.Store',
    fields: ["id", "descripcion"],
    data: [
...
Ext.define('corporacionsoluma.store.DetalleAbastecimiento', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('corporacionsoluma.store.DetalleOrdenCompra', {
    extend: 'Ext.data.Store',
    fields: [
            {name: "idprod", type:'int' },
            {name: "producto", type:'string' },
 ...
 */
Ext.define('corporacionsoluma.store.TmpOrdenCompraConfirmadas', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('corporacionsoluma.store.DetProductoProveedor', {
    extend: 'Ext.data.Store',
    fields: [
            {name: "razonsocial"},
            {name: "precio", type:'float' }
...
Ext.define('corporacionsoluma.store.PagosAcuenta', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('corporacionsoluma.store.CajaDetalleVenta', {
    extend: 'Ext.data.Store',
    fields: [
      {name: "idprod", type:'int' },
      {name: "producto", type:'string' },
...
Ext.define('corporacionsoluma.store.GuiaRemisionDetalle', {
    extend: 'Ext.data.Store',
    fields: [
...
Ext.define('corporacionsoluma.store.DetListaMateriales', {
    extend: 'Ext.data.Store',
    fields: [
            {name: "producto"},
            {name: "cantidad", type:'float' },
...
Ext.define('corporacionsoluma.store.BusquedaEstado', {
    extend: 'Ext.data.Store',
    fields: [
